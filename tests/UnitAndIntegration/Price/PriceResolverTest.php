...
class PriceResolverTest extends TestCase
{
    ...
    private VatCalculator|MockObject $vatCalculator;
    ...
    public function setUp(): void 
    {
        ...
        $this->vatCalculator = $this->createMock(VatCalculator::class);

        $this->priceResolver = new PriceResolver($this->vatResolver, $this->security, $this->countryLocation, $this->vatCalculator);
    }
    ...
    public function testResolveWithConsumerOutFranceInEU()
    {
        ...
        $vatAmount = 50; // peu importe le nombre
        $this->vatCalculator->expects($this->once())
                            ->method('calcVatAmountFromHT')
                            ->with(150, 210)
                            ->willReturn($vatAmount);
