...
class PicturePathResolverTest extends TestCase
{
    ...
    public function testGetAltWithPictureHavingAltProperty()
    {
        ...
        $this->assertEquals('alt_es', $this->picturePathResolver->getAlt($picture, 'es'));
        $this->assertEquals('alt_fr', $this->picturePathResolver->getAlt($picture, 'fr'));
    }
    public function testGetAltWithPictureNotHavingAltProperty()
    {
        $picture = new Picture;
        $this->assertEquals('Photo', $this->picturePathResolver->getAlt($picture, 'en'));
    }
    public function testGetAltWithNullParam()
    {
        $this->assertEquals('Photo', $this->picturePathResolver->getAlt(null, 'it'));
    }
    public function testGetAltWithInexistantLangParam()
    {
        $picture = (new Picture)->setAlt(
            (new TranslatableString)
            ->setEn('alt_en')
        ...
        $this->assertEquals('Photo', $this->picturePathResolver->getAlt($picture, 'inexistant'));
    }
