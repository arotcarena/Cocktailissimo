...
export const DownloadIcon = ({additionalClass, ...props}) => {
    return (
        <svg className={'icon i-download' + (additionalClass ? ' ' + additionalClass: '')} {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
