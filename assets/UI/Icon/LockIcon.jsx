...
export const LockIcon = ({additionalClass, ...props}) => {
    return (
        <svg className={'icon i-lock' + (additionalClass ? ' ' + additionalClass: '')} {...props} viewBox="-64 0 512 512" xmlns="http://www.w3.org/2000/svg">
