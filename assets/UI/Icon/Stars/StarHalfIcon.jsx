...
export const StarHalfIcon = ({additionalClass, ...props}) => {
    return (
        <svg className={'icon i-star' + (additionalClass ? ' ' + additionalClass: '')} {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 97.092 97.092" enableBackground="new 0 0 97.092 97.092">
            <g>
