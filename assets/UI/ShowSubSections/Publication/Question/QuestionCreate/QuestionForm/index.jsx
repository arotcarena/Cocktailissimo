...
export const QuestionForm = ({createQuestion, close}) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="review-form box-form">
            ...
            <TextField control={control} name="title" error={errors.title?.message} maxLength={100}>{t('question_title')} *</TextField>

            <TextField type="textarea" control={control} name="content" error={errors.question?.message} maxLength={500}>
                {t('question')} *
            </TextField>
