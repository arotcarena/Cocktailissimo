...
export const InstagramLink = ({className, ...props}) => {
    return (
        <a 
            href="https://www.instagram.com/cocktaillissimo/" 
            className={className} 
            aria-label={t('follow_us_on_instagram', {ns: 'messages'})}
            title={t('follow_us_on_instagram', {ns: 'messages'})}
            >
            <svg className="icon i-social i-instagram" {...props} version="1.1" id="instagram" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512">
                <g>
                <g>
